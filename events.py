...
class MouseMoveEvent(Event):
    ...
    def __init__(self, axis, value):
        ...
        super().__init__(_type = Event.MOUSE_MOVE, axis=axis, value=value)
...
class MouseWheelEvent(Event):
    ...
    def __init__(self, value):
        super().__init__(_type = Event.MOUSE_WHEEL, value=value)
...
class PressEvent(Event):
    ...
    def __init__(self, key):
        super().__init__(_type = Event.PRESS, key=key)
...
class ReleaseEvent(Event):
    ...
    def __init__(self, key):
        super().__init__(_type = Event.RELEASE, key=key)
